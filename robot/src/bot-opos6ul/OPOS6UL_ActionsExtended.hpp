...
//	96825465| O_ServoObjectsTest INFO Lshouldr(1052)= 431
//	 96836352| O_ServoObjectsTest INFO Lelbow  (1062)= 232
//	 96847262| O_ServoObjectsTest INFO Lwrist  (1061)= 170
//	 96858172| O_ServoObjectsTest INFO Lfinger (1003)= 237
//	 96858219| O_ServoObjectsTest INFO
//	 96869080| O_ServoObjectsTest INFO Rshouldr(1008)= 598
...
//	 96901776| O_ServoObjectsTest INFO Rfinger (1051)= 497
	...
	void ax12_retract_in_block(int time_eta_ms = 400, int keep_ms = 0)
	{
		...
		servos().move_2_servos(time_eta_ms, AX12_SERVO_ELBOW_R, 782, AX12_SERVO_WRIST_R, 864, 0, 1023, 1023);
		servos().move_2_servos(time_eta_ms, AX12_SERVO_ELBOW_L, 232, AX12_SERVO_WRIST_L, 170, keep_ms, 1023, 1023);
		utils::sleep_for_millis(500);
		servos().move_1_servo(300, AX12_SERVO_SHOULDER_R, 598, 0, 1023);
		servos().move_1_servo(300, AX12_SERVO_SHOULDER_L, 431, 0, 1023);
	}
...
//		ax12_open_R(1000, 0);
	...
	/*!
	 * \brief Initialise le bras droit (épaule, coude, poignet) à la position de repos.
	 * \param time_eta_ms Durée estimée du mouvement en ms.
	 * \param keep_ms Durée de maintien en ms (-1 = attendre fin du mouvement).
	 */
	...
	/*!
	 * \brief Initialise le bras gauche (épaule, coude, poignet) à la position de repos.
	 * \param time_eta_ms Durée estimée du mouvement en ms.
	 * \param keep_ms Durée de maintien en ms (-1 = attendre fin du mouvement).
	 */
	...
	/*!
	 * \brief Initialise les deux bras (gauche et droit) à la position de repos.
	 * \param time_eta_ms Durée estimée du mouvement en ms.
	 * \param keep_ms Durée de maintien en ms (-1 = attendre fin du mouvement).
	 */
	...
	/*!
	 * \brief Initialise le servo de la banderole à la position repliée.
	 * \param time_eta_ms Durée estimée du mouvement en ms.
	 * \param keep_ms Durée de maintien en ms (-1 = attendre fin du mouvement).
	 */
	...
	/*!
	 * \brief Déploie la banderole (action de fin de match).
	 * \param time_eta_ms Durée estimée du mouvement en ms.
	 * \param keep_ms Durée de maintien en ms (-1 = attendre fin du mouvement).
	 */
...
*/
	/*
	 ...
	 39309266| O_ServoObjectsTest INFO

	 deployé
	 52812792| O_ServoObjectsTest INFO AX12_SERVO_BRAS_D       N° 1005 pos= 670
	 52824304| O_ServoObjectsTest INFO AX12_SERVO_BRAS_G       N° 1007 pos= 346
	 */
