 ...
 * === Triangle 500mm ===
 *
 *   ./bot-opos6ul t /n 9 750 250  500 683  250 250 /m 0 /+ 250 250 0
 *   ./bot-opos6ul t /n 9 750 250  500 683  250 250 /m 2 /+ 250 250 0
 *
 * === Aller-retour ===
 *
 *   ./bot-opos6ul t /n 9 750 250  250 250 /m 0 /+ 250 250 0
 *   ./bot-opos6ul t /n 9 750 250  250 250 /m 2 /+ 250 250 0
 *
 * === Avec detection adverse ===
 *
 *   ./bot-opos6ul t /n 9 750 250  750 750  250 750  250 250 /m 2 /B 1 /+ 250 250 0
 *
 * === Vitesse reduite 20% ===
 *
 *   ./bot-opos6ul t /n 9 750 250  750 750  250 750  250 250 /m 2 /s 20 /+ 250 250 0
 *
...
public:
    ...
    O_AsservWaypointTest() :
            FunctionalTest("Asserv_Waypoint", "Navigation par waypoints (Navigator).")
    {
    }
