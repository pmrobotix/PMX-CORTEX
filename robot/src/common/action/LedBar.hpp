/*! \file LedBar.hpp
 * \brief Gestion de la barre de LEDs et ses actions/timers associés.
 */
#ifndef LEDBAR_HPP_
#define LEDBAR_HPP_
...
/*!
 * \brief Gestion d'une barre de LEDs avec actions et timers de clignotement.
 */
...
public:
    ...
    /*!
     * \brief Réinitialise les demandes d'arrêt des timers et actions.
     */
    void resetStop() {
    ...
    /*!
     * \brief Indique si un arrêt du timer a été demandé.
     */
    bool hasToStop() {
    ...
    /*!
     * \brief Définit l'état d'exécution en cours.
     */
    ...
    /*!
     * \brief Retourne vrai si une action ou un timer est en cours.
     */
    bool running() const {
        return running_;
    }
    ...
    /*!
     * \brief Retourne le nombre de LEDs de la barre.
     */
    int nbLed() const {
        return nbLed_;
    }
