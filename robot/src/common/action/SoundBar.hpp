/*! \file
 * \brief Définition de la classe SoundBar et de l'action SoundBarAction.
 */
...
/*!
 * \brief Gère la barre de son du robot (beeps, mélodies, synthèse vocale).
 */
...
public:
    ...
    /*!
     * \brief Indique si l'action en cours doit être stoppée.
     * \return \c true si l'action est stoppée.
     */
    ...
    /*!
     * \brief Joue The Imperial March (thème de Dark Vador).
     */
    void toneImperialMarchDarthVader();

    /*!
     * \brief Prononce "PMX" via la synthèse vocale.
     */
    void speakPMX();

    /*!
     * \brief Émet un beep sonore.
     */
    void beep();

    /*!
     * \brief Lance l'action asynchrone d'émission d'un beep.
     */
    void startBeep();
