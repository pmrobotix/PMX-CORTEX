 ...
 *
 *              Modifié pour carte linux par cho.
 *******************************************************************/
...
private:
    ...
    /*!
     * \brief Retourne le \ref Logger associé à la classe \ref MD25 (OPOS6UL).
     */
    static const logs::Logger & logger() {
        static const logs::Logger & instance = logs::LoggerFactory::logger("MD25.OPO");
        return instance;
    }
    ...
    int read(unsigned char reg_addr, unsigned char *data, int bytes);
    //char doDiscover();
...
public:
    ...
    int i2c_addr_set(unsigned char address);         // Set a new I2C device address (Default: 0xB0).
